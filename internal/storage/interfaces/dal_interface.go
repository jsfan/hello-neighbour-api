...
type AccessInterface interface {
	...
	InsertChurch(ctx context.Context, churchIn *model.ChurchIn) (church *models.ChurchProfile, errVal error)
	InsertUser(ctx context.Context, userIn *model.UserIn) error
